...
public class AdvancedLoomScreenHandler extends ScreenHandler {
   ...
   public AdvancedLoomScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, ScreenHandlerContext context) {
      ...
      this.inputA = this.addSlot(new Slot(inventory, 0, 13, 25));
      this.inputB = this.addSlot(new Slot(inventory, 1, 33, 25));
      this.inputC = this.addSlot(new Slot(inventory, 2, 13, 44));
      this.inputD = this.addSlot(new Slot(inventory, 3, 33, 44));
